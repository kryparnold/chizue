export const localizations = {
	tr: {
		...
		gameExists: (gameType: string) => `Bu kanalda **${gameType}** mevcut.`,
		gameDoesntExists: "Bu kanalda oyun yok.",
		gameAnother: (game: string) => `Bu kanalda ${game} mevcut.`,
	...
	en: {
		...
		gameSetupSuccess: "Game setup successful!",
		gameRemoveSuccess: "Game removal successful.",
		...
		gameMode: "Game Mode",
		gameModeNormalDesc: "Normal game mode, the game cannot be finished until 40 words.",
		gameModeEndlessDesc: "Endless game mode, the game cannot be finished.",
